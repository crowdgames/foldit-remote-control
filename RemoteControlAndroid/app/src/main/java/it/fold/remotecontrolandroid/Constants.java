...
public class Constants {
    public static final int CUR_IMG_WIDTH        = 1184; // defaults only...
    public static final int CUR_IMG_HEIGHT       = 768;
    public static final int REAL_IMG_WIDTH       = 1184;
    public static final int REAL_IMG_HEIGHT      =  768;
